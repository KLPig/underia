...
single.QUEST_NAME["class-melee"].add_child(single.QuestBlock(qid="demon_blade__muramasa", name="Muramasa: The Demon\'s Blade", desc="", content="Muramasa deals strong damage.\n[Q]: quick stab.", reqs=[single.ItemRequirement(item='demon_blade__muramasa', num=1)], req_num=1, pos=(900, -1300), disp="demon_blade__muramasa", pre=[],))
single.QUEST_NAME["class-melee"].add_child(single.QuestBlock(qid="ark_of_elements", name="The Ark: Elements", desc="", content="Ark of Elements have 3 states, switching states deal more damage.", reqs=[], req_num=0, pos=(600, -1300), disp="ark_of_elements", pre=[],))
...
single.QUEST_NAME["excalibur"].add_child(single.QuestBlock(qid="true_excalibur", name="True Excalibur", desc="", content="A strong melee weapon which strong large range of projectiles.", reqs=[single.ItemRequirement(item='true_excalibur', num=1)], req_num=1, pos=(1800, -1300), disp="true_excalibur", pre=[single.QUEST_NAME['spirit_essence']]))
single.QUEST_NAME["nights_edge"].add_child(single.QuestBlock(qid="true_nights_edge", name="True Nights Edge", desc="", content="A strong melee weapon which shoots energy.", reqs=[single.ItemRequirement(item='true_nights_edge', num=1)], req_num=1, pos=(1800, -1100), disp="true_nights_edge", pre=[single.QUEST_NAME['spirit_essence']]))
single.QUEST_NAME["true_nights_edge"].add_child(single.QuestBlock(qid="the_blade", name="The Blade", desc="", content="The blade can be thrown out and gives strong beams.", reqs=[single.ItemRequirement(item='the_blade', num=1)], req_num=1, pos=(2100, -1200), disp="the_blade", pre=[single.QUEST_NAME['true_excalibur']]))
single.QUEST_NAME["spiritual_heart"].add_child(single.QuestBlock(qid="eternity", name="Embracing Eternity!", desc="", content="Now, for difficulties higher than normal, \nenable ETERNAL for difficulty 2.\n\nETERNAL MODE increases enemies\' HP and \nadd bosses attack logic.", reqs=[single.ConstantRequirement(tr='DIFFICULTY2',tv=2), single.ViewRequirement()], req_num=2, pos=(2100, 500), disp="eternal_pocket_watch", pre=[],))
single.QUEST_NAME["eternity"].add_child(single.QuestBlock(qid="demise", name="Even More?", desc="", content="For difficulties higher than mastery, \nenable DEMISE for difficulty 2.\n\nDEMISE MODE increases enemies\' HP and \nadd even more bosses attack logic.", reqs=[single.ViewRequirement(), single.ConstantRequirement(tr='DIFFICULTY2',tv=3)], req_num=2, pos=(2300, 500), disp="dark_matter", pre=[],))
single.QUEST_NAME["the_blade"].add_child(single.QuestBlock(qid="zenith", name="Zenith", desc="", content="Deals rapid damage - the final melee weapon.", reqs=[single.ItemRequirement(item='zenith', num=1)], req_num=1, pos=(1200, -1500), disp="zenith", pre=[single.QUEST_NAME['demon_blade__muramasa'], single.QUEST_NAME['class-melee']],))
# insert

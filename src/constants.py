...
def load_settings(settings):
    ...
    elif len(settings) == 27:
        ELEMENT_TYPE_CONSTANT, DAMAGE_TYPE_CONSTANT, INFINITY, APRIL_FOOL, LANG, DEBUG, OS, TONE, ENTITY_NUMBER, \
            WEB_DEPLOY, FLAGS, FULLSCREEN, USE_ALPHA, EASY_BACKGROUND, BLADE_EFFECT_QUALITY, PARTICLES,  \
            HEART_BAR, FADING_PARTICLE, FPS, OS_NICE, LIGHTING, MOVER_POS, ULTIMATE_AMMO_BONUS, MUSIC_VOL, SOUND_VOL, DIFFICULTY, DIFFICULTY2 = settings
    elif len(settings) == 28:
        (ELEMENT_TYPE_CONSTANT, DAMAGE_TYPE_CONSTANT, INFINITY, APRIL_FOOL, LANG, DEBUG, OS, TONE, ENTITY_NUMBER, \
            WEB_DEPLOY, FLAGS, FULLSCREEN, USE_ALPHA, EASY_BACKGROUND, BLADE_EFFECT_QUALITY, PARTICLES,  \
            HEART_BAR, FADING_PARTICLE, FPS, OS_NICE, LIGHTING, MOVER_POS, ULTIMATE_AMMO_BONUS, MUSIC_VOL, SOUND_VOL,
         DIFFICULTY, DIFFICULTY2, RESOLUTION) = settings
    else:

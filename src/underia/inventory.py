...
items_dict: dict[str, Inventory.Item] = {
    ...
    'nature': Inventory.Item('Nature', 'A red, shiny stone.\nIt\'s acts as a stable "cash" for trading', 'nature', 12,
                             [TAGS['item']]),
...
'natural_necklace': Inventory.Item('Natural Necklace', '+4/sec mana regeneration', 'natural_necklace', 0,
    ...
    'arrayed_amulet': Inventory.Item('Arrayed Amulet', 'br_chaosImmune to ALL debuffs dealt by biomes(includeing CHAOS ABYSS).\ncolff0000Speed addons are DISABLED.',
    ...
    'life_fruit': Inventory.Item('Life Fruit', '+60 maximum hp (when HP >= 640)\nwWhen HP reaches 1000, your talent will come to a significant increase.', 'life_fruit', 7,
                                 [TAGS['item']]),
    ...
    'sky_painting': Inventory.Item('Sky Painting', 'Summon the sky tri-kubes', 'sky_painting', 0, [TAGS['item'], TAGS['sacred']]),
...
RECIPES = [
    ...
    Recipe({'cauldron': 1, 'vitaflora': 2, 'red_algae': 2, 'firite_ingot': 1}, 'healing_potion', 2),
    ...
    Recipe({'cauldron': 1, 'dendrobium': 3, 'anemovitis': 2, 'vitaflora': 1, 'aerialite_ingot': 1}, 'storm_potion'),
    ...
    Recipe({'thermal_ingot': 18, 'starlight_shard': 2, 'mithrill_anvil': 1}, 'fire_shine'),
    Recipe({'thermal_ingot': 15, 'firy_plant': 8, 'mithrill_anvil': 1}, 'fires_defense'),
    ...
    Recipe({'shotgun': 1, 'daedalus_ingot': 15, 'soul_of_justice': 25, 'soul_of_bravery': 10},
           'justice_shotgun'),
    Recipe({'aimer': 1, 'daedalus_ingot': 20, 'soul_of_justice': 25, 'soul_of_patience': 10},
           'critically'),
    ...
    Recipe({'chlorophyte_ingot': 16, 'soul_of_perseverance': 18, 'leaf': 50},
           'life_devourer'),
    Recipe({'chlorophyte_ingot': 18, 'soul_of_perseverance': 15, 'soul_of_growth': 25, 'leaf': 80},
           'leavigour'),
    Recipe({'chlorophyte_ingot': 24, 'soul_of_justice': 18, 'photon': 20, 'leaf': 20},
           'lazer_rain'),
    Recipe({'chlorophyte_ingot': 18, 'soul_of_justice': 18, 'soul_of_perseverance': 6, 'leaf': 20},
           'lazer_gun'),
    Recipe({'chlorophyte_ingot': 32, 'soul_of_justice': 12, 'soul_of_perseverance': 12, 'leaf': 20},
           'lazer_sniper'),
    Recipe({'chlorophyte_ingot': 8, 'photon': 20, 'soul_of_growth': 45, 'leaf': 50}, 'growth'),
    Recipe({'prism': 1, 'chlorophyte_ingot': 12, 'photon': 30}, 'prism_wand'),
    ...
    Recipe({'soul_of_growth': 12, 'chlorophyte_ingot': 1, 'life_core': 5}, 'life_fruit'),
    ...
    Recipe({'chaos_ingot': 15, 'fire_gloves': 1, 'palladium_gloves': 1, 'mithrill_gloves': 1,
            'titanium_gloves': 1, 'tough_gloves': 1, 'origin': 1}, 'starnight_gloves'),
    Recipe({'chaos_ingot': 15, 'broken_copper_boots': 1, 'lava_walker': 1, 'highspeed_boots': 1,
            'life_boots': 1, 'guardian_necklace': 1, 'origin': 1}, 'corrupt_boots'),
    ...
    Recipe({'chaos_ingot': 400, 'soul_of_determination': 20, 'origin_feather': 10}, 'eternal_wings'),
    Recipe({'chaos_ingot': 400, 'soul_of_determination': 20, 'origin_feather': 10}, 'eternal_pocket_watch'),
    ...
    Recipe({'chaos_ingot': 600, 'soul_of_determination': 12, 'origin_feather': 5, 'light_essence': 25, 'celestial_fountain': 1, 'time_fountain': 1}, 'ember'),
    Recipe({'chaos_ingot': 30, 'soul_of_determination': 1, 'light_essence': 2}, 'scorching_arrow', 20),
    Recipe({'chaos_ingot': 50, 'soul_of_determination': 3, 'time_essence': 3, 'origin_feather': 1}, 'eterrow', 100),
    ...
    Recipe({'blood_ingot': 21, 'anvil': 1}, 'bloody_chestplate'),
    ...
    Recipe({'forgotten_shard': 20, 'coral_reef': 15, 'sea_pearl': 1, 'anvil': 1}, 'tidal_mask'),
    Recipe({'forgotten_shard': 25, 'coral_reef': 18, 'sea_pearl': 1, 'anvil': 1}, 'tidal_chestplate'),
    Recipe({'forgotten_shard': 18, 'coral_reef': 12, 'sea_pearl': 1, 'anvil': 1}, 'tidal_gear'),

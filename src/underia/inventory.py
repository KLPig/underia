...
RECIPES = [
    ...
    Recipe({'zirconium_ingot': 15, 'magic_stone': 8, 'anvil': 1}, 'zirconium_wand'),
    Recipe({'wood': 60, 'magic_stone': 15, 'leaf': 5, 'platinum_ingot': 5, 'anvil': 1}, 'life_wooden_sword'),
    Recipe({'wood': 60, 'magic_stone': 15, 'leaf': 5, 'zirconium_ingot': 5, 'anvil': 1}, 'life_wooden_sword'),
    ...
    Recipe({'wood': 20, 'leaf': 20, 'coniferous_leaf': 50, 'blood_ingot': 32, 'floatstone': 2, 'obsidian_ingot': 2, 'anvil': 1}, 'forests_bow'),
    ...
    Recipe({'platinum_ingot': 12, 'storm_core': 3, 'floatstone': 10}, 'storm_stabber'),
    ...
    Recipe({'storm_core': 1, 'starstorm_bottle': 1, 'snow_wings': 1, 'floatstone': 10}, 'soarer_bottle'),

...
RECIPES = [
    ...
    Recipe({'blood_ingot': 20, 'firite_ingot': 20, 'anvil': 1}, 'aimer'),
    ...
    Recipe({'firy_plant': 10, 'platinum_ingot': 100}, 'firite_ingot', 50),
    Recipe({'firy_plant': 1, 'mysterious_substance': 4, 'furnace': 1}, 'mysterious_ingot', 1),
    Recipe({'firy_plant': 1, 'mysterious_substance': 10, 'furnace': 1}, 'mysterious_ingot', 3),
    ...
    Recipe({'storm_core': 1, 'platinum_ingot': 100}, 'mysterious_ingot', 50),
